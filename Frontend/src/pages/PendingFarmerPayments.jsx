...
const PendingFarmerPayments = () => {
  ...
  const fetchPendingPayments = async () => {
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/analytics/v1/get-pending-farmer-payments`,
        {
          startDate,
          endDate,
        },
      ...
      console.error("Pending Farmer Payments:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-8">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-white border-b text-red-600 border-gray-200 h-16 flex items-center px-4 shadow-sm">
        <button
          onClick={() => navigate(-1)}
          ...
          <div className="space-y-4">
            {farmers.map((farmer) => (
              <PendingPersonCard
                ...
                pendingQuantity={farmer.pendingQuantity}
                pendingAmount={farmer.pendingAmount}
                totalTransactions={farmer.totalPurchases}
...
export default PendingFarmerPayments;