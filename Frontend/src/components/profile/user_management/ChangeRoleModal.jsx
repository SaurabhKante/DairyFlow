...
const ChangeRoleModal = ({
  ...
  const handleUpdateRole = async () => {
    try {
      ...
      await axios.put(
        `${BASE_URL}/user/v1/update-role/${selectedUser.userId}`,
        {
          role,
        },
        {
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6">
        ...
        <div className="flex gap-3 mt-8">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 h-12 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold transition disabled:opacity-50"
          >
